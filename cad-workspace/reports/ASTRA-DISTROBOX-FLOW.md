...
dentro do `distrobox trabalho` == o habilitado, não o Hermes.
...
runuser -u nerton -- /home/nerton/tcc-pnaat/github/cad-workspace/tools/r03-astra.sh --status
# 3. rodar o agente sobre um prompt
runuser -u nerton -- /home/nerton/tcc-pnaat/github/cad-workspace/tools/r03-astra.sh prompts/codex-r03-freecad-mcp.md
```
