...
Documento de encerramento da sessão de 2026-09-09. Repositório canônico: `github/` (HEAD `9a9eb23`, github remoto). Workspace LaTeX em `latex-workspace/`; compilação via distrobox `trabalho` no <host>.
