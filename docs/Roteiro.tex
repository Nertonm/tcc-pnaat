...
\begin{itemize}
    ...
    \item Fechar a introdução com a pergunta que a solução vai responder: "como identificar esses itens defeituosos antes que cheguem a essa etapa para que a gente separe as garrafas defeituosas manualmente com segurança?"
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item o operador recebe a notificação para separar as garrafas defeituosas manualmente após a indicação do sistema.
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item passagem das três garrafas com defeito conhecido, uma de cada vez — onde o sistema aponta a falha e a gente separa as garrafas defeituosas manualmente;
...
\begin{itemize}
    ...
    \item Retomar a solução em uma frase: inspeção multi-vista com classificação automática e sinalização visual, permitindo que a gente separa as garrafas defeituosas manualmente antes que causem problemas maiores.
